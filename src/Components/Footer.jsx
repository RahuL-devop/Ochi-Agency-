    ...
    <>
      <div className="flex h-screen w-full gap-8 bg-zinc-900 px-12">
        ...
        <div className="w-1/2 font-['Neue_Montreal']">
          <h1 className="mb-2 text-[6vw] leading-none tracking-tighter">
            PRESENTATIONS
          </h1>

          <div className="links flex items-center gap-[20vw]">
            <div className="w-1/2 ">
              ...
              <div className="mt-8">
                {[
                  ...
                  <div key={i}>
                    <a className="block cursor-pointer">{e}</a>
                    {i === 1 && <div className="mt-5"></div>}
                  </div>
                ))}
              </div>
